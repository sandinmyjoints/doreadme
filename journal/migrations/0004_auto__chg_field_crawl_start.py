...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Crawl.start'
        db.alter_column('journal_crawl', 'start', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))


    def backwards(self, orm):
        
        # Changing field 'Crawl.start'
        db.alter_column('journal_crawl', 'start', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
