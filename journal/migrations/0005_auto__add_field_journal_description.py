...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('journal_journal', 'description', self.gf('django.db.models.fields.TextField')(max_length=1024, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Journal.description'
        db.delete_column('journal_journal', 'description')
