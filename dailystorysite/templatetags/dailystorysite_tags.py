...
HEADLESS_DESCRIPTION = "presents a taste of new short fiction from across the internet every day. Read on if you're intrigued, or come back tomorrow for a different story."
