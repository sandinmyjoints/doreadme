...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Story.crawl_flagged'
        db.add_column('story_story', 'crawl_flagged', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Story.crawl_flagged'
        db.delete_column('story_story', 'crawl_flagged')
