...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Story', fields ['author', 'title']
        db.create_unique('story_story', ['author', 'title'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Story', fields ['author', 'title']
        db.delete_unique('story_story', ['author', 'title'])
