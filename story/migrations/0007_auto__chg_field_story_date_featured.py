...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Story.date_featured'
        db.alter_column('story_story', 'date_featured', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Story.date_featured'
        db.alter_column('story_story', 'date_featured', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        ...
        'story.story': {
            ...
            'date_featured': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
