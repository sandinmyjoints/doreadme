...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('story_story', 'genre', self.gf('django.db.models.fields.CharField')(default='FI', max_length=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Story.genre'
        db.delete_column('story_story', 'genre')
